...
export function InfiniteSlider({
  ...
  // Support both duration and speed props (speed is pixels/sec, duration is total seconds)
  const resolvedDuration = duration ?? (speed ? 100 / speed * 10 : 25);
  const resolvedDurationOnHover = durationOnHover ?? (speedOnHover ? 100 / speedOnHover * 10 : undefined);
