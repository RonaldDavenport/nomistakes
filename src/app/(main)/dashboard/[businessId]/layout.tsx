...
const NAV_GROUPS = (businessId: string) => [
  ...
  },
  {
    ...
    items: [
      ...
      { href: `/dashboard/${businessId}/contracts`, label: "Contracts", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" },
      { href: `/dashboard/${businessId}/time`, label: "Time", icon: "M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: `/dashboard/${businessId}/automations`, label: "Automations", icon: "M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" },
    ],
  },
];
