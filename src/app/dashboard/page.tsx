    ...
    <div className="p-8">
      ...
      {businesses.length === 0 ? (
        ...
        <div className="grid gap-4">
          {businesses.map((biz) => (
            <div key={biz.id} className="p-6 rounded-xl border border-white/5 bg-surface/50 hover:border-brand-600/30 transition-all">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-brand-400 text-sm mb-2">{biz.tagline}</p>
